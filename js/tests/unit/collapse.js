$(function () {
  ...
  QUnit.test('should remove "collapsed" class from all triggers targeting href of target when collapse is shown', function (assert) {
    var done = assert.async()
  ...
  QUnit.test('should set aria-expanded="true" on all triggers targeting href of target when collapse is shown', function (assert) {
    var done = assert.async()
  ...
  QUnit.test('should set aria-expanded="false" on all triggers targeting href of target when collapse is hidden', function (assert) {
    var done = assert.async()
